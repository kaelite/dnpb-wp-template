...
// Breadcrumbs
if ( !function_exists( 'dnpb_breadcrumbs' ) ) {
	function dnpb_breadcrumbs( $args = array() ) {
		...
		$defaults = array(
			...
			'breadcrumbs_classes' => 'dnpb-breadcrumbs',
			'home_title'          => __('Home')
		);
		...
		$html = apply_filters( 'dnpb_breadcrumbs_filter', $html );
